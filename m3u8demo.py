...
# 动态区域
url_list=[
    'http://hls.videocc.net/b034527feb/9/b034527febcdbb20f59d3072c3f41849_2.m3u8?pid=1676599967241X1691046&device=desktop',
    'http://hls.videocc.net/b034527feb/e/b034527feb1822e8f5eb8b595806392e_2.m3u8?pid=1676600013119X1013391&device=desktop',
]#在这里天上你要下载的m3u8文件的URL
token_list=[
    '?token=a3b2ed1c-10a0-4c56-a571-7b69b3a6732e-j0',
    '?token=8f3a8830-50f5-483e-a037-c03a24a34b05-60',
]
path_list=[
    '高数/第二章 一元函数微分学(2022)/考点一 导数与微分/',
    '高数/第二章 一元函数微分学(2022)/考点一 导数与微分/',
]
title_list=[
    '导数与微分（上）',
