...
# 动态区域
url_list=[
    'http://hls.videocc.net/b034527feb/f/b034527feb9a9b1c98d71611dbdcc77f_3.m3u8?pid=1676558867582X1285569&device=desktop',
]#在这里天上你要下载的m3u8文件的URL
token_list=[
    '?token=bcd67f71-40d7-4c18-bca1-b34ffff45aa2-80',
]
path_list=[
    '高数/第一章 极限和连续(2022)/考点三 连续/',
]
title_list=[
    '连续',
]
